                ...
                axios.post(`/api/validate-order`, data).then(res=>{
                    if(res.data.status === 200)
                    {
                        ...
                        var options = {
                            ...
                            "amount": (1 * 100),
                            "name": "bkshop", 
                            "description": "Thank you for purchasingg",
    ...
    else
    {
        checkout_HTML = <div>
            <div className="card card-body py-5 text-center shadow-sm">
                <h4>Your Shopping Cart is Empty. You are in Checout Page</h4>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModalLabel">Online Payment Mode</h1>
