        ...
        axios.get('/sanctum/csrf-cookie').then(response => {
            ...
            .then(res => {
                if(res.data.status === 200){
                    ...
                    swal("success", res.data.message, 'success message')
                    history.push('/')
                }else{
                    setRegister({...registerInput, err_list: res.data.validationError})
                }
            })
        });
